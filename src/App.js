...
class App extends Component {
  constructor(props) {
    ...
    this.handleIsASimpsons = this.handleIsASimpsons.bind(this);
  }
  ...
  render() {
    return (
      <div>
        <button onClick={this.handleIsASimpsons}> Simpson Quote </button>

        {this.state.quoteList
        .filter(quoteList => !this.state.isSimpsons || quoteList.character.includes("Simpson"))
        .map((quote, index) => (
          <QuoteCard {...quote} />
        ))}
      </div>
